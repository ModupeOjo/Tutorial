...
```{r external-image, echo=FALSE, out.width="30%", fig.align="center"}
knitr::include_graphics("https://github.com/ModupeOjo/Tutorial/blob/master/static/images/Picture1.png")
```
